...
export default function HomePage() {
    ...
    return (
        <ThemedView style={styles.container}>
            ...
            >
                <Pressable onPress={handleListOpen} style={[styles.searchContainer, isIOS ? styles.searchContainerIOS : null]}>
                    <SearchLogo />
            ...
            {listOpen && (
                <View style={[styles.fullscreenDropdown, { backgroundColor: 'transparent' }]}>
                    <View style={styles.dropdownScroll}>
                        {listItems.slice(0, 14).map((v, index, array) => (
                            ...
                            >
                                <Pressable style={styles.dropdownItem} onPress={() => handleSelectListValue(v)}>
...
const styles = StyleSheet.create({
    ...
    card: { backgroundColor: '#f3f3f3', borderRadius: 18, padding: 14, marginTop: 80 },
    ...
    dropdown: { position: 'absolute', left: 20, right: 20, top: 120, borderRadius: 10, padding: 8, elevation: 4, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 4, shadowOffset: { width: 0, height: 2 } },
    dropdownItem: { paddingVertical: 13, paddingHorizontal: 8 },
    fullscreenDropdown: { position: 'absolute', left: 0, right: 0, top: 136, bottom: 0, zIndex: 200, borderTopLeftRadius: 12, borderTopRightRadius: 12, overflow: 'hidden' },
